...
1.  Watch failure rates spike during the simulated HDFC outage.
2.  See the agent reason and provide a JSON-based diagnosis in the middle panel.
3.  Monitor the Action: Watch the "Reroute" decision take effect.
4.  Observe Recovery: See the "Bank Health" bars return to green after intervention.
